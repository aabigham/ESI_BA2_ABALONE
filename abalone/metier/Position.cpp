...
const Direction Position::computeDirection(Position posStart, Position posArrival) const
{
...
Position Position::toPosition(const std::string abapro) const // THROWS !!!!!!!!!!
{
